    ...
    <div class="container-fluid main">
      <div class="text-container">
        <h1 class="principal">
          ...
          <p>mais distantes de você!</p>
        </h1>
      </div>
      <router-link
        to="/item/list"
        tag="button"
        class="btn btn-outline-light btn-main btn-lg"
      >
        Compartilhar!
      </router-link>
    </div>
...
.principal {
  font-size: 2.5rem;
  color: black;
  font-family: "BC Alphapipe L", sans-serif;
  margin-top: 4%;
}
...
.main {
  ...
  background-color: linear-gradient(
    38deg,
    rgba(105, 99, 213, 1) 8%,
    rgba(108, 99, 255, 1) 47%,
    rgba(91, 81, 245, 1) 100%
  );
  height: 100vh;
  width: 100%;
  text-align: center;
  background-image: url("../assets/wallpaper2.svg");
